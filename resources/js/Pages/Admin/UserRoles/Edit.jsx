...
export default function Edit({ role }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    put(route('admin.user-roles.update', role.id));
  };

  return (
    <AdminLayout>
      <Head title={`Edit User Role: ${role.name}`} />
          ...
          <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 bg-white border-b border-gray-200">
              <div className="flex items-center mb-6">
                ...
                <h1 className="text-2xl font-semibold text-gray-900">Edit User Role: {role.name}</h1>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  >
                    {processing ? 'Updating...' : 'Update User Role'}
                  </button>
                </div>
              </form>
            </div>
